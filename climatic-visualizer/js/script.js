...
// fetch(`https://api.openweathermap.org/data/2.5/weather?q=São Paulo&appid=349eafe701e9079d6378df93bbb79282`)
// http://api.openweathermap.org/data/2.5/weather?units={units}&q={location}&APPID=349eafe701e9079d6378df93bbb79282
// http://api.openweathermap.org/data/2.5/forecast?units={units}&q={location}&APPID=349eafe701e9079d6378df93bbb79282


(function ($, window, h) {
    'use strict';
  
    var weatherAPI = 'https://api.openweathermap.org/data/2.5/weather?units={units}&q=São Paulo&appid=349eafe701e9079d6378df93bbb79282',
        forcastAPI = 'https://api.openweathermap.org/data/2.5/weather?units={units}&q=São Paulo&appid=349eafe701e9079d6378df93bbb79282',
